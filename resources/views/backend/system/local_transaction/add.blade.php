    ...
    <div class="row">
        ...
        <article class="col-md-9">
            @box_open(trans("bus.add.title"))
                <div>
                    {!! Form::open(["url" => "/system/local_transaction", "method" => "post"]) !!}
                    <div class="widget-body">
                        {!! Form::lbSelect("from_id", null, App\Models\Balance::system()->toOption("brief_information"), "From") !!}
                        {!! Form::lbSelect("to_id", null, App\Models\Balance::system()->toOption("brief_information"), "To") !!}
                        {!! Form::lbText("amount", 0, "Amount") !!}
                        {!! Form::lbText("fee", 1100, "Fee") !!}
